...
static void
bilateral_slice_cpu_forward_kernel(scalar_t * __restrict__ output,
...
template <typename scalar_t>
static void
bilateral_slice_cpu_grid_grad_kernel(scalar_t * __restrict__ out_grid_grad,
...
template <typename scalar_t>
static void
bilateral_slice_cpu_guide_grad_kernel(scalar_t * __restrict__ out_guide_grad,
                                      scalar_t * __restrict__ upstream_grad,
                                      scalar_t * __restrict__ bilateral_grid,
                                      scalar_t * __restrict__ guide,
                                      scalar_t * __restrict__ input,
...
template <typename scalar_t>
static void
bilateral_slice_cpu_input_grad_kernel(scalar_t * __restrict__ out_input_grad,
                                      scalar_t * __restrict__ upstream_grad,
                                      scalar_t * __restrict__ bilateral_grid,
                                      scalar_t * __restrict__ guide,
                                      GridSizes gsz,
                            ...
                            bool has_offset)
{
        ...
        AT_DISPATCH_FLOATING_TYPES(
                guide.type(),
                "bilateral_slice_cpu_forward",
                ([&] {
                 bilateral_slice_cpu_forward_kernel<scalar_t>(
                             ...
                             bool has_offset)
{
        ...
        AT_DISPATCH_FLOATING_TYPES(
                guide.type(),
                "bilateral_slice_cpu_grid_grad_kernel",
                ([&] {
                 bilateral_slice_cpu_grid_grad_kernel<scalar_t>(
        ...
        AT_DISPATCH_FLOATING_TYPES(
                guide.type(),
                "bilateral_slice_cpu_guide_grad_kernel",
                ([&] {
                 bilateral_slice_cpu_guide_grad_kernel<scalar_t>(
        ...
        AT_DISPATCH_FLOATING_TYPES(
                input.type(),
                "bilateral_slice_cpu_input_grad_kernel",
                ([&] {
                 bilateral_slice_cpu_input_grad_kernel<scalar_t>(
